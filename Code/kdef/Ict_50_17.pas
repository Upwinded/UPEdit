...
procedure TForm55.ComboBox2Select(Sender: TObject);
begin
...
procedure TForm55.ComboBox3Select(Sender: TObject);
var
...
procedure TForm55.initial(atrb:Pattrib);
var
